...
export const HomeScreen = (props) => {
    ...
    return (
        <div>
            ...
            <div className="min-h-screen px-12 w-full font-noto-sans p-4 sm:px-20 py-[12vh] sm:py-[16vh] sm:pb-4">
                ...
                <div className="flex flex-col sm:flex-row justify-around my-10 py-10 space-y-12 sm:space-y-0">
                    <div className="rounded-lg bg-slate-300 text-black h-fit p-10 sm:w-[30%]">
                        <h3 className="font-bold text-xl">A Web Developer for Egg Harbor Cafe</h3>
                        <br></br>
                        <p>
                            Egg Harbor is a breakfast restaurant with over 15 locations in 3 different states. I am working on Search Engine Optimization, decreasing load times, analyzing Google Analytics, and redesigning the site to be more sleek and user-friendly.
                            <br></br><br></br><img src="https://eggharborcafe.com/wp-content/uploads/2019/11/cropped-EHC-Logo-RED.png" className="w-1/4"></img>
                            <br></br><br></br><a target="_blank" href="https://eggharborcafe.com/">https://eggharborcafe.com</a>
                    ...
                    <div className="sm:w-[30%]">
                        <div className="rounded-lg bg-slate-300 text-black h-fit p-10 ">
                        ...
                        <div className="flex flex-col sm:flex-row justify-around mb-10 py-10 space-y-12 sm:space-y-0 justify-start">
                            <div className="rounded-lg bg-slate-300 text-black h-fit p-10 ">
