            ...
            <div className="rounded-xl w-11/12 mt-12 h-auto py-6 px-10 bg-black">
                <div className="flex flex-row">
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="sm:font-medium pr-32 text-gray-400">I authored commits to implement logo display, tags, and titles for Worldle on mobile devices. This game has over <strong>1 million players </strong> daily. </p>
                    </div>
            ...
            <div className="rounded-xl w-11/12 mt-12 h-auto py-6 px-10 bg-black">
                <div className="flex flex-row">
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="sm:font-medium pr-32 text-gray-400">Servicing over 300 students, the D128 Driving app allows students to track their hours and join virtual classrooms to streamline the drivers education process. </p>
                    </div>
            ...
            <div className="rounded-xl w-11/12 mt-12 h-auto py-6 px-10 bg-black">
                <div className="flex flex-row">
                    <div className="flex flex-col space-y-4">
                        ...
                        <p className="sm:font-medium pr-32 text-gray-400">The High School Mathematical Modeling Contest in Modeling is a nationwide competition where teams of four use algorithms and math to model a given real life problem. I was tasked to find the best schedule of government funding toward ecological conservation which maximized biodiversity. Attatched is the resultant formal research paper. </p>
                    </div>
                    <a target="_blank" className="flex flex-col items-center" href="https://drive.google.com/file/d/1tpFdCSgjsYU5WfzgoucAsiPLD4UJYEW2/view?usp=sharing"><img className="w-80 bg-gray-200" src="./images/paper.svg"></img>
                        *view*
                    </a>
                </div>
            </div>
